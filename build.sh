...
if [ $(uname) = "Darwin" ]; then
  ...
  clang++ -c "filesystem.cpp" "gamemaker.cpp" -shared -std=c++17 -lc -lkvm -lpthread -fPIC && clang++ "filesystem.o" "gamemaker.o"  -o "libfilesystem.so" -shared -std=c++17 -lc -lpthread -fPIC;
  ar rc libfilesystem.a gamemaker.o filesystem.o && rm -f "gamemaker.o" "filesystem.o";
else
